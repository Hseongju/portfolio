...
var commonScript = (function(){
  return {
    ...
    init: function(){
      if(window.location.href.indexOf("http://ldcs.easymedia.kr/") > -1 || window.location.href.indexOf('127.0.0.1') > -1 || window.location.href.indexOf("http://eznet1.easymedia.kr") > -1) {
    ...
    headerFooterFn: function(){
      ...
      $("header nav .gnb > li").each(function(q){
        ...
        $(this).find(".one_depth").on("mouseenter focusin", function(){
          if(window.innerWidth > 1024){
            ...
            // $("header nav .gnb > li .two_pack").fadeIn();
            $(this).parents("li").siblings().find(".two_pack").css("z-index","3")
            $("header nav .gnb > li").eq($(this).parents("li").index()).find(".two_pack").css({"z-index":"5","height":"414px"});
      ...
      if($(".class_gate_w").size() > 0){
        $(".class_gate_w .tab_btn_area .btn").each(function(q){
          $(this).on("mouseover", function(){
            if(!$(this).hasClass("on")){
              ...
              // $(".class_gate_w .tab_img_area .img").eq(q).fadeIn(200, function(){
              //   $(".class_gate_w .tab_img_area .img").not($(this)).hide()
              // });
        ...
        $(".class_gate_w .tab_con_area .accordion_type .list_div .radio_flex_box .form_radio label").on("click", function(){
      ...
      $("footer .layer_popup .pop_wrap .btn_close").on("click", function(){
        if(window.innerWidth > 1024){
          $("footer .layer_popup").find(".pop_wrap").css("display","block")
        }

        $("footer .layer_popup").fadeOut(300, function(){
          $("body").removeClass("stop_scroll")
          $("header").removeClass("law_index");
          $(".btn_top").removeClass("law_index");
          $(".m_navi_bar").removeClass("hide");
        });
    ...
    commonFn: function(){
      ...
      // 탭 이미지 너비
      if($(".filter_bar_area .tab_con_area").size() > 0) {
        $(".filter_bar_area .tab_con_area .circle_sel_swiper").each(function(q) {
          _barWidthArr[q] = ($(this).find(".swiper-slide .img").innerWidth() + 40) * $(this).find(".swiper-slide .img").length;
        });
      }
      ...
      if($(".thr_dep_area").size() > 0) {
        $(".thr_dep_area").each(function(q) {
          $(this).find(".swiper-slide").each(function(i) {
            _thrTotalWidth += $(this).outerWidth(true);
            if(_thrTotalWidth <= $(this).parents(".thr_dep_area").find(".swiper-container").width()) {
              $(".thr_dep_area").find(".drop_btn").removeClass("show");
            } else {
              $(".thr_dep_area").find(".drop_btn").addClass("show");
            }
          });
        });
      }
      ...
      if($(".accordion_type").size() > 0) {
        $(".accordion_type").each(function() {
          $(this).find(".list_div .list").on("click", function() {
      ...
      // 결제상세, 수강결제 드롭다운
      $(".txt_con .drop_type").on("click", function(){
        //수강결제
      ...
      // 재료비,대여비 없는경우
      if($(".total_price_info").hasClass("no_cost")){
        $(".total_price_info").find(".material").hide().prev().hide();
      }
      
      // 할인금액 없는 경우
      if($(".total_price_info").hasClass("no_sale")){
        $(".total_price_info").find(".sales").hide().prev().hide();
      }
      ...
      if($(".dual_list").size() > 0){
        ...
        if($(".single_type").size() > 0) {
          $(".cour_his_list").find(".drop_type").on("click", function(){
          ...
          $(this).on("click", function() {
            if(!$(this).hasClass("price_input_wrap")){
              ...
              $(".reset_wrap .filter_btn").on("click", function() {
                ...
                // $(this).parents(".srch_popup").find(".list_div").removeClass("on");
                // $(this).parents(".srch_popup").find(".hide_con").stop(true, true).slideUp();
              });
            }
          });
        });
      ...
      if($(".page_title_area .tit_div.arrow").size() > 0) {
        $(".page_title_area .tit_div.arrow").on("click", function() {
          ...
          if($(this).hasClass("active")) {
            ...
            $(".m_navi_bar").addClass("hide");
            $(this).siblings(".tit_popup").stop(true, true).slideDown();
            $(".tit_popup .pop_cont").height($(".tit_popup").find(".pop_wrap").height() - $(".tit_popup").find(".pop_head").innerHeight());
      ...
      if($(".filter_bar_div").size() > 0) {
        ...
        $(".srch_data_div").each(function(){
          ...
          $(this).find(".reset_data").on("click", function(){
            $(this).parents(".srch_data_div").remove();
            $(this).parents(".srch_data_div").find(".srch_data_list").find("p").remove();
          });
        });

        // 필터 알림 토스트 팝업
        // $(".info_box").each(function(){
        //   $(this).find(".close_btn").each(function(){
        //     $(this).on("click", function() {
        //       if(!$(this).parent().hasClass("hide")) {
        //         $(this).parent().siblings(".detail_srch_btn").removeClass("on");
      ...
      if($(".srch_popup").size() > 0) {
        ...
        $(".srch_popup .dimd, .srch_popup .btn_close").on("click", function() {
          ...
          // $(this).parents(".srch_popup").find(".srch_con .list_div").removeClass("on");
          // $(this).parents(".srch_popup").find(".srch_con .list_div .hide_con").stop(true, true).slideUp();
          // $(this).parents(".srch_popup").find(".srch_con .list_div .filter_btn_list .btn").removeClass("on");
          ...
          // $(this).parents(".srch_popup").find(".divide_wrap .toggle_area .f_caption1").parent().addClass("hide");
          // $(this).parents(".srch_popup").find(".divide_wrap .toggle_area .f_caption1").siblings(".num").text("0");
        });
        ...
        $(".right_box_fix_area .course_popup").each(function(q) {
          ...
          $(this).find(".single_btn_area").on("click", function() {
            ...
            if(window.innerWidth > 1024) {
              ...
              if($(".course_popup.list").hasClass("active")) {
                ...
                gsap.to(".course_popup.list .pop_wrap .pop_cont .for_padding .box_con, .course_popup.list .btn_area", {duration: .3, "opacity": 1, delay: .35});
          ...
          $(".right_box_fix_area .box_prev_btn, .right_box_fix_area .fix_box_area .box_dimd").off().on("click", function() {
            ...
            if(window.innerWidth <= 1024) {
              ...
              gsap.to(".course_popup.list .pop_wrap .pop_cont .for_padding .box_con, .course_popup.list .btn_area", {duration: .3, "opacity": 0, delay: .2});
        ...
        if($(".right_box_fix_area .info_img_txt").size() > 0) {
          $(".right_box_fix_area .more_btn_wrap").each(function() {
            $(this).find(".more_btn").on("click", function() {
              ...
              if($(this).hasClass("on")) {
                $(this).parent().siblings(".info_img_txt").addClass("show")
                $(this).find("span").text("강좌소개 닫기");
              } else {
                $(this).parent().siblings(".info_img_txt").removeClass("show");
      ...
      //       arrImagesUrl[i] = new Image();
      //       arrImagesUrl[i].src = preload.arguments[i];
      //     }
      //   }

      //   preload(
      //     "/common/images/img-class-search-gate-1.jpg",
      //     "/common/images/img-class-search-gate-2.jpg",
      //     "/common/images/img-class-search-gate-3.jpg",
      //     "/common/images/img-class-search-gate-4.jpg",
      //     "/common/images/img-class-search-gate-5.jpg",
      //     "/common/images/img-class-search-gate-6.jpg",
      //     "/common/images/img-class-search-gate-7.jpg",
      //     "/common/images/img-class-search-gate-8.jpg",
      //     "/common/images/img-class-search-gate-9.jpg",
      //     "/common/images/img-class-search-gate-10.jpg",
      //     "/common/images/img-class-search-gate-11.jpg",
      //     "/common/images/img-class-search-gate-12.jpg",
      //     "/common/images/img-class-search-gate-13.jpg",
      //     "/common/images/img-class-search-gate-14.jpg",
      //     "/common/images/img-class-search-gate-15.jpg",
      //     "/common/images/img-class-search-gate-16.jpg",
      //     "/common/images/img-class-search-gate-17.jpg",
      //     "/common/images/img-class-search-gate-18.jpg",
      //     "/common/images/img-class-search-gate-19.jpg",
      //     "/common/images/img-class-search-gate-20.jpg",
      //     "/common/images/img-class-search-gate-21.jpg",
      //     "/common/images/img-class-search-gate-22.jpg",
      //     "/common/images/img-class-search-gate-23.jpg",
      //     "/common/images/img-class-search-gate-24.jpg",
      //     "/common/images/img-class-search-gate-25.jpg",
      //     "/common/images/img-class-search-gate-26.jpg",
      //     "/common/images/img-class-search-gate-27.jpg",
      //     "/common/images/img-class-search-gate-28.jpg",
      //     "/common/images/img-class-search-gate-29.jpg",
      //     "/common/images/img-class-search-gate-30.jpg",
      //     "/common/images/img-class-search-gate-31.jpg",
      //     "/common/images/img-class-search-gate-32.jpg",
      //     "/common/images/img-class-search-gate-33.jpg",
      //     "/common/images/img-class-search-gate-34.jpg",
      //     "/common/images/img-class-search-gate-35.jpg",
      //     "/common/images/img-class-search-gate-36.jpg",
      //     "/common/images/img-class-search-gate-37.jpg",
      //     "/common/images/img-class-search-gate-38.jpg",
      //     "/common/images/img-class-search-gate-39.jpg",
      //     "/common/images/img-class-search-gate-40.jpg",
      //     "/common/images/img-class-search-gate-41.jpg",
      //     "/common/images/img-class-search-gate-42.jpg",
      //     "/common/images/img-class-search-gate-43.jpg",
      //     "/common/images/img-class-search-gate-44.jpg",
      //     "/common/images/img-class-search-gate-45.jpg",
      //     "/common/images/img-class-search-gate-46.jpg",
      //     "/common/images/img-class-search-gate-47.jpg",
      //     "/common/images/img-class-search-gate-48.jpg",
      //     "/common/images/img-class-search-gate-49.jpg",
      //     "/common/images/img-class-search-gate-50.jpg",
      //     "/common/images/img-class-search-gate-51.jpg",
      //     "/common/images/img-class-search-gate-52.jpg",
      //     "/common/images/img-class-search-gate-53.jpg",
      //     "/common/images/img-class-search-gate-54.jpg",
      //   )
      // }
      ...
      // 출석부
      if($(".attend_wrap").size() > 0){
        $(".attend_wrap .attend_table .tr .td .border_btn").each(function(){
          $(this).on("click", function(){
            if(!$(this).parents(".tr").hasClass("check")){
    ...
    formChkFn: function(){
      ...
      $(".form_search, .form_input").each(function(q){
        ...
        //   $(this).find("input").closest(".form_search, .form_input").find(".btn_delete").hide();
        // }
      ...
      $(".form_select_div").each(function(){
        $(this).off("click").on("click", function(){
          if(!$(this).hasClass("on")){
            ...
            $(this).addClass("on");
            $(this).find(".list_wrap").stop(true, true).slideDown();
            ...
            if($(".right_box_fix_area .course_popup").size() > 0) {
              if(window.innerWidth <= 1024) {
                if($(this).parents(".course_popup").hasClass("multiple")) {
                  $(this).parents(".course_popup.multiple").removeClass("active");
                  $(".right_box_fix_area .fix_box_area .box_dimd").hide();
                } else {
            ...
            $(this).removeClass("on");
            $(this).find(".list_wrap").stop(true, true).slideUp();
            ...
            if($(".right_box_fix_area .course_popup").size() > 0) {
              if($(this).parents(".course_popup").hasClass("multiple")) {
                $(this).parents(".course_popup.multiple").addClass("active");
        ...
        $(this).find(".list_wrap .btn_link").each(function(q){
          $(this).on("click", function(){
            ...
            if($(".cont_wrap").hasClass("main")){
              ...
              // $(this).parents(".category_wrap").find(".category_con").removeClass("on");
              // $(this).parents(".category_wrap").find(".category_con").eq(q).addClass("on");
...
function classScrollPosition(){
  if($(".select_reload").size() > 0){
    gsap.to($("html, body"), 0, {scrollTop:$(".fixed_mobile_w").offset().top, delay:2, ease:Power3.easeOut})
  }
}
